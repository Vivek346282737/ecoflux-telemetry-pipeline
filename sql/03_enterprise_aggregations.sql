-- Enterprise Resource KPI Generation & Window Metrics

-- 1. Facility Monthly Trend & Moving Rolling Average
SELECT 
    f.facility_id,
    f.facility_name,
    s.sensor_type,
...
-- 2. Regional Consumption Contribution & Percentile Ranking
SELECT 
    f.operating_region,
    s.sensor_type,
